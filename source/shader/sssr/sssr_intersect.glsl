...
void main()
{
    ...
    const vec3 worldNormal = texelFetch(inGbufferB, ivec2(rayCoord), 0).xyz; 
    ...
    vec3 envFallback = getIBLContribution(roughness, worldNormal, normalize(frameData.camWorldPos.xyz - worldOrigin));
