...
%~dp0/../glslc.exe -fshader-stage=comp --target-env=vulkan1.3 %~dp0/ssss_blur.glsl -O -o %~dp0/../../../install/shader/ssss_blur.comp.spv

%~dp0/../glslc.exe -fshader-stage=comp --target-env=vulkan1.3 %~dp0/outline.glsl -O -o %~dp0/../../../install/shader/outline.comp.spv