...
struct ComponentDrawer
{
	...
	static void drawMMDCamera(std::shared_ptr<engine::SceneNode> node);
	static void drawSpotLight(std::shared_ptr<engine::SceneNode> node);
};
