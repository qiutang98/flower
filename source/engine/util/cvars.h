...
namespace engine
{
	...
	constexpr auto kCVarMaxInt32Num  = 4000;
	constexpr auto kCVarMaxFloatNum  = 4000;
	constexpr auto kCVarMaxBoolNum   = 4000;
	constexpr auto kCVarMaxStringNum = 1000;
