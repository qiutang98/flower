...
namespace engine
{
	...
	protected:
		...
		void initTemplate(const char* name, VkDescriptorType type, const VulkanContext* inContext, uint32_t maxDeviceLimit);
	...
	public:
		...
		virtual void init(const char* name, const VulkanContext* context) = 0;
	...
	public:
		...
		virtual void init(const char* name, const VulkanContext* context) override;
