...
namespace engine
{
    ...
    uint32_t DescriptorLayoutCache::DescriptorLayoutInfo::hash() const
    {
        return crc::crc32((void*)bindings.data(), uint32_t(bindings.size() * sizeof(VkDescriptorSetLayoutBinding)));
    }
